...
<h2 style="font-family:Helvetica,sans-serif;text-align:center;
   font-style:italic; font-weight:bold;">Your Orderlist</h2>
...
<%
  ...
  ArrayList<OrderBean>list=orderManager.getOrder(name);
  if(list.size()==0){%>
  <tr>
...
<a style="display:block; text-align:center; font-size:15px;" href="shop.jsp">Shop More!</a>
</body>
</html>